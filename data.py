...
class SalObjDataset(data.Dataset):
    def __init__(self, image_root, gt_root, trainsize):
        ...
        self.images = [image_root + f for f in os.listdir(image_root) if f.endswith('.jpg') or f.endswith('.bmp') or f.endswith('.png')]  #gai
        self.gts = [gt_root + f for f in os.listdir(gt_root) if f.endswith('.bmp')
                    or f.endswith('.png') or f.endswith('.jpg')]  #gai
    ...
    def load_data(self):
       ...
       # print(name)
        ...
        if name.endswith('.bmp'):
            name = name.split('.bmp')[0] + '.png'  #msrc .png  --  .bmp
        self.index += 1
       # print(name)
